...
def test_add_new_pet_with_valid_data(name='Арчи', animal_type='Собака',
                                     age='8', pet_photo='images/Dog.jpg'):
...
def test_successful_delete_own_pet():
    ...
    if len(my_pets['pets']) == 0:
        ptFnd.add_new_pet(auth_key, 'Даня', 'Кот', '5', 'images/Cat.jpg')
        _, my_pets = ptFnd.get_list_of_pets(auth_key, 'my_pets')
...
def test_successful_update_own_pet_info(name='Мурзик', animal_type='Кот прекрасный', age='6'):
...
def test_set_photo_pet(pet_photo='images/Dog.jpg'):
...
def test_add_new_pet_with_incorrect_age(name='Матроскин', animal_type='Бельчёнок',
...
def test_update_not_own_pet_info(name='Чебурашка', animal_type='Инопланетянин', age='7'):
...
def test_set_photo_not_own_pet(pet_photo='images/Dog.jpg'):
